...
aadharPart3: data?.aadhaarNumber?.slice(8, 12) || '',
  ...
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-10 p-1 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="text" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" {...formik.getFieldProps("admissionNumber")} disabled placeholder="Admission Number" />
        </div>
        <div>
          <div> <label htmlFor="" className="font-medium ">Roll Number</label> </div>
          <input type="number" {...formik.getFieldProps("rollNumber")} min={1} placeholder="Roll Number" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" />
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("firstName")} placeholder="First Name" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" />
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("lastName")} placeholder="Last Name" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" />
        ...
        <div>
          ...
          <select {...formik.getFieldProps("class")} className="input w-full border-[1px] border-gray-300 p-1 rounded-md">
    ...
    return (
      <option key={classNumber} value={`${classNumber}${suffix}`}>
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("section")} placeholder="Section" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" />
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("session")} placeholder="Session" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" />
          {formik.touched.section && formik.errors.section && <div className="text-red-500">{formik.errors.section}</div>}
        </div>
        <div>
          <div> <label htmlFor="" className="font-medium ">Date Of Birth</label> </div>
          <input type="date" {...formik.getFieldProps("dateOfBirth")} className="input w-full border-[1px] border-gray-300 p-1 rounded-md" />
        ...
        <div>
          ...
          <select {...formik.getFieldProps("gender")} className="input w-full border-[1px] border-gray-300 p-1 rounded-md">
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("nationality")} placeholder="Nationality" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" />
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("permanentAddress")} placeholder="Permanent Address" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" /></div>
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("correspondenceAddress")} placeholder="Correspondence Address" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" disabled={sameAddress} />
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("contactNumber")} placeholder="Contact Number" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" /></div>
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("alternateContactNumber")} placeholder="Alternate Contact Number" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" /></div>
        ...
        <div>
          ...
          <input type="email" {...formik.getFieldProps("email")} placeholder="Email" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" /></div>
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("category")} placeholder="Category" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" /></div>
        ...
        <div>
          ...
          <input type="date" {...formik.getFieldProps("dateOfAdmission")} className="input w-full border-[1px] border-gray-300 p-1 rounded-md" /></div>
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("fatherName")} placeholder="Father's Name" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" /></div>
        ...
        <div>
          ...
          <input type="text" {...formik.getFieldProps("motherName")} placeholder="Mother's Name" className="input w-full border-[1px] border-gray-300 p-1 rounded-md" /></div>
        ...
        {/* Image Upload */}
        <label className="input w-full border-[1px] border-gray-300 p-1 rounded-md cursor-pointer flex items-center space-x-2">
